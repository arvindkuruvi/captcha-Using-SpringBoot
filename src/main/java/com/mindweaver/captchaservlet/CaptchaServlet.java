package com.mindweaver.captchaservlet;
...
import com.mindweaver.service.captchaservice.CaptchaServiceImpl;


@CrossOrigin(origins = "*")
@WebServlet("/captcha/get-captcha")
@RequestMapping("/")
public class CaptchaServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		session.setAttribute("captcha", captcha);
		 ...
		 //using the captcharegister from captchacontroller to store the generated captcha
		CaptchaServiceImpl.captchaRegister.put(captcha , new CaptchaRequest(captcha));
